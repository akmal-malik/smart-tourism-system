...
function Home() {
  return (
    <div className="font-sans">
      {/* HERO SECTION with overlay and better text contrast */}
      <div className="relative bg-[url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e')] bg-cover bg-center h-[85vh] flex items-center justify-center">
      ...
      {/* INFO SECTION - Cards with hover effects */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-center border border-gray-100">
              ...
              <p className="text-gray-600">Reserve your stay and enjoy the breathtaking bamboo forests and serene environment at Bangkong Kahoy Valley.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-center border border-gray-100">
              <div className="text-4xl mb-4">📊</div>
              <h3 className="text-2xl font-semibold mb-3 text-blue-700">View Tourism Data</h3>
              <p className="text-gray-600">Access real-time visitor statistics, peak season trends, and other key tourism insights instantly.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-center border border-gray-100">
              <div className="text-4xl mb-4">📋</div>
              <h3 className="text-2xl font-semibold mb-3 text-gray-700">Request Information</h3>
              <p className="text-gray-600">Submit data requests, ask questions, and track their status easily through our portal.</p>
            </div>
          </div>
        </div>
      </div>
